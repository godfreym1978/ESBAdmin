		...
		try {
			...
			if (objType.equals("QUEUE")) {
				qMgrBytes = String.valueOf(
						pcfCM.createQScript(qHost, Integer.parseInt(qPort), objName, qChannel)).getBytes();
				outStream.write(qMgrBytes);
			}

			if (objType.equals("CHANNEL")) {
				qMgrBytes = String.valueOf(
						pcfCM.createChlScript(qHost, Integer.parseInt(qPort), objName, qChannel))
						.getBytes();
				outStream.write(qMgrBytes);
			}
			...
			if (objType.equals("LISTENER")) {
				qMgrBytes = String.valueOf(
						pcfCM.createListScript(qHost, Integer.parseInt(qPort), objName, qChannel))
						.getBytes();
				outStream.write(qMgrBytes);
			}
			...
			if (objType.equals("TOPIC")) {
				qMgrBytes = String.valueOf(
						pcfCM.createTopicScript(qHost, Integer.parseInt(qPort), objName, qChannel))
						.getBytes();
				outStream.write(qMgrBytes);
			}
			...
			if (objType.equals("SUB")) {
				qMgrBytes = String.valueOf(
						pcfCM.createSubScript(qHost, Integer.parseInt(qPort), objName, qChannel))
						.getBytes();
				outStream.write(qMgrBytes);
			}
